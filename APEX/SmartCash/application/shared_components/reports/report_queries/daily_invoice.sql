...
wwv_flow_imp_shared.create_shared_query(
 p_id=>wwv_flow_imp.id(10872036590789656095)
...
,p_report_layout_id=>wwv_flow_imp.id(11470053473278791231)
,p_format=>'PDF'
,p_output_file_name=>'daily_invoice'
,p_content_disposition=>'ATTACHMENT'
);
wwv_flow_imp_shared.create_shared_query_stmnt(
 p_id=>wwv_flow_imp.id(11469853426956328024)
,p_shared_query_id=>wwv_flow_imp.id(10872036590789656095)
